...
insert into t_admin(username,password,role_name) values('superadmin','123456','superadmin'),('admin1','123456','normaladmin');
...
insert into t_post(title,content,admin_id,create_date) values('Leave notice','Please pay attention to holiday safety!',1,'2017-4-30');
...
insert into t_dept(dept_name,dept_description) values('course','make courses'),('development','Software development');
...
insert into t_position(pos_name,pos_description) values('Java course staff','make Java courses'),('front-end engineers','responsible for front-end development');
...
create table employee_tb(
	...
	foreign key(pos_id) references t_position(pos_id)
);
